...
class LoraStar
{
  ...
  public:
    ...
    void create_packet_data_and_send(uint16_t destination_addr, char *payload);
...
void LoraStar::create_packet_data_and_send(uint16_t destination_addr, char *payload)
{
  BaseType_t TWres = pdPASS;

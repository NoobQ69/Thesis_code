...
int Database::list_directory(fs::FS &fs, const char *dirname, uint8_t levels) {
...
int Database::create_diretory(fs::FS &fs, const char *path) {
...
int Database::remove_directory(fs::FS &fs, const char *path) {
...
void Database::get_SD_card_info() {
...
int Database::read_file(fs::FS &fs, const char *path, String &text_str, int &number_of_line) {
...
int Database::write_file(fs::FS &fs, const char *path, const char *message, bool is_new_line = false) {
...
int Database::append_file(fs::FS &fs, const char *path, const char *message, bool is_new_line = false) {
...
int Database::rename_file(fs::FS &fs, const char *path1, const char *path2) {
...
bool Database::delete_file(fs::FS &fs, const char *path) {
...
bool Database::delete_line(fs::FS &fs, const char *path, int line) {
...
bool Database::get_number_of_line(fs::FS &fs, const char *path, int *line) {
...
bool Database::read_line(fs::FS &fs, const char *path, char *lineStorage, int lineNumber) {
  ...
  File file = fs.open(path);
  if (!file) {
    Serial.println("Failed to open file for reading a line");
    return DATABASE_ERROR_FAILED_OPEN_FILE;
  }
...
bool Database::read_line(fs::FS &fs, const char *path, String &lineStorage, int lineNumber) {
  Serial.print("Reading a line on file: ");
  Serial.println(path);
